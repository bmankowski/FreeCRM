...
# Skrypt do konwersji konstrukcji App\Language::translate na LanguageTranslator::translate w plikach PHP
# Autor: Assistant
# Data: $(date)
...
while IFS= read -r file; do
    ...
    # Wzorzec: App\Language::translate('KEY', $MODULE) -> LanguageTranslator::translate('KEY', $MODULE)
    if [ "$DRY_RUN" = true ]; then
        ...
        # 1. App\Language::translate -> LanguageTranslator::translate
        sed "s/App\\\\Language::translate/LanguageTranslator::translate/g" "$file" > "$temp_file"
        # 2. \App\Language::translate -> LanguageTranslator::translate
        sed -i "s/\\\\App\\\\Language::translate/LanguageTranslator::translate/g" "$temp_file"
        # 3. Language::translate -> LanguageTranslator::translate (w namespace App)
