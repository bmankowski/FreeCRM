...
class LogIn extends TestCase
{
	...
	{
		ob_start();
		(new Vtiger_WebUI())->process(new \App\Http\Vtiger_Request($_REQUEST, $_REQUEST));
	...
	public function testLoginInToCrm()
	{
		...
		if ($user->doLogin($userName)) {
			...
			Vtiger_Session::set('app_unique_key', \App\Core\AppConfig::main('application_unique_key'));
