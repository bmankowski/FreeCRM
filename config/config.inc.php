...
\FreeCRM\AppConfig::iniSet('memory_limit', '512M');

// lifetime of session
\FreeCRM\AppConfig::iniSet('session.gc_maxlifetime', '21600');
...
// helpdesk support email id and support name (Example: 'support@titantech.pl' and 'yetiforce support')
