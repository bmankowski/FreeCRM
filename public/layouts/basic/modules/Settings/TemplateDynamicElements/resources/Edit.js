 ...
 * @copyright (c) FreeCRM
 */
Settings_Vtiger_Edit_Js('Settings_TemplateDynamicElements_Edit_Js', {}, {
	codeMirrors: {},
	registerCodeGeneration: function () {
		...
		label.on('keyup change', function () {
			...
			code.val(Settings_TemplateDynamicElements_Edit_Js.generateCode(label.val()));
		});
		code.on('keyup change', function () {
			code.data('manualChange', true);
			code.val(Settings_TemplateDynamicElements_Edit_Js.generateCode(code.val()));
		});
	},
...
Settings_TemplateDynamicElements_Edit_Js.generateCode = function (value) {
