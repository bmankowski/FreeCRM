 ...
 *************************************************************************************/
Vtiger_ListView_Js("Reports_ListView_Js", {
	listInstance: false,
	addReport: function (url) {
		var listInstance = Reports_ListView_Js.listInstance;
		...
		AppConnector.request(params).then(
				function (data) {
					...
					var callBackFunction = function (data) {
						...
						Reports_ListView_Js.listInstance.folderSubmit().then(function (data) {
							if (data.success) {
								var result = data.result;
								if (result.success) {
									app.hideModalWindow();
									var info = result.info;
									Reports_ListView_Js.listInstance.updateCustomFilter(info);
								} else {
		...
		if (validationResult != true) {
			...
			AppConnector.request(params).then(
					function (data) {
						progressIndicatorElement.progressIndicator({'mode': 'hide'});
						var callBackFunction = function (data) {
							var reportsListInstance = new Reports_ListView_Js();
	...
	init: function () {
		Reports_ListView_Js.listInstance = this;
	},
	...
	registerEditFilterClickEvent: function () {
		...
		listViewFilterBlock.on('mouseup', 'li span.editFilter', function (event) {
			...
			Reports_ListView_Js.triggerAddFolder(editUrl);
