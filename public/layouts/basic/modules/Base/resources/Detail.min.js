		...
		detailContentsHolder.on('click', '.listViewEntries', function (e) {
			...
			if (typeof recordUrl != "undefined") {
				...
				if (relatedView === 'ListPreview') {
					...
					var selectedTabElement = instance.getSelectedTab();
					var relatedModuleName = instance.getRelatedModuleName();
					var RelatedListController = instance.getRelatedListControllerClass();
					var relatedController = new RelatedListController(instance.getRecordId(), app.getModuleName(), selectedTabElement, relatedModuleName);
