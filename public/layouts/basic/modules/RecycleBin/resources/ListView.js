...
Vtiger_ListView_Js("RecycleBin_ListView_Js", {
    emptyRecycleBin: function(url) {
        ...
        Vtiger_Helper_Js.showConfirmationBox({'message': message}).then(
                function(e) {
                    ...
                    var instance = new RecycleBin_ListView_Js();
    ...
    deleteRecord : function(recordId) {
        recordId = RecycleBin_ListView_Js.convertToJsonString(recordId);
		var listInstance = Vtiger_ListView_Js.getInstance();
    ...
    */
	...
	registerDeleteRecordClickEvent: function(){
		...
		listViewContentDiv.on('click','.deleteRecordButton',function(e){
			...
			RecycleBin_ListView_Js.deleteRecord(recordId);
			e.stopPropagation();
		});
	}, 
	...
	registerRestoreRecordClickEvent: function(){
		...
		listViewContentDiv.on('click','.restoreRecordButton',function(e){
			var elem = jQuery(e.currentTarget);
			var recordId = elem.closest('tr').data('id');
			RecycleBin_ListView_Js.restoreRecord(recordId);
			e.stopPropagation();
		});
	},
