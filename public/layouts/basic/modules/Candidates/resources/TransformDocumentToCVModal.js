...
jQuery.Class('Candidates_TransformDocumentToCVModal_Js', {}, {
	...
	registerEvents: function () {
		var container = jQuery('.modalCandidatesTransformDocumentToCVModal');
		this.registerSubmit(container);
	}
});

jQuery(document).ready(function () {
	(new Candidates_TransformDocumentToCVModal_Js()).registerEvents();
});
