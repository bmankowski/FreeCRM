 ...
 * All Rights Reserved.
 *************************************************************************************/
Vtiger_ListView_Js("Portal_ListView_Js",{
    ...
    editBookmark : function(params) {
        AppConnector.request(params).then(function(data) {
            var callBackFunction = function(data) {
                Portal_ListView_Js.saveBookmark();
            };
        ...
        jQuery('#saveBookmark').on('submit',function(e){
            ...
            AppConnector.request(params).then(function(data) {
                if(data.success) {
                    ...
                    var url = Portal_ListView_Js.getDefaultParams();
                    Portal_ListView_Js.loadListViewContent(url);
                    app.hideModalWindow();
                }
            });
        });
    ...
    loadListViewContent : function(url) {
        ...
        AppConnector.requestPjax(url).then(function(data) {
            ...
            Portal_ListView_Js.updatePagination();
        });
    },
