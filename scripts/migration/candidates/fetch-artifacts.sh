...
scp "$REMOTE_HOST:/tmp/candidates_core.sql" "$TMP_DIR/candidates_core.sql"
scp "$REMOTE_HOST:/tmp/projekty_core.sql" "$TMP_DIR/projekty_core.sql"
scp "$REMOTE_HOST:/tmp/candidates_relations.sql" "$TMP_DIR/candidates_relations.sql"
scp "$REMOTE_HOST:/tmp/modcomments_core.sql" "$TMP_DIR/modcomments_core.sql"
scp "$REMOTE_HOST:/tmp/candidates_ids.tsv" "$TMP_DIR/candidates_ids.tsv"
