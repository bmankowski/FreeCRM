...
$credits = [
	...
	'PHP — Composer' => [
		...
		['name' => 'HTML Purifier', 'version' => '4.18.0', 'license' => 'LGPL-2.1', 'url' => 'https://htmlpurifier.org/', 'body' => 'HTML sanitization.'],
	...
	'PHP — Bundled' => [
		['name' => 'SabreDAV', 'version' => '2.1.3', 'license' => 'BSD-3-Clause', 'url' => 'https://sabre.io/', 'body' => 'CalDAV and CardDAV API.'],
	...
	'JavaScript & CSS — Core UI' => [
		...
		['name' => 'DOMPurify', 'version' => '0.8.9', 'license' => 'MPL-2.0', 'url' => 'https://github.com/cure53/DOMPurify', 'body' => 'Client-side HTML sanitization.'],
	...
	'JavaScript & CSS — Feature libraries' => [
		['name' => 'CKEditor', 'version' => '4.6.2', 'license' => 'GPL/LGPL/MPL', 'url' => 'https://ckeditor.com/', 'body' => 'Rich text editor.'],
		['name' => 'CodeMirror', 'version' => '5', 'license' => 'MIT', 'url' => 'https://codemirror.net/', 'body' => 'Code editor for templates.'],
