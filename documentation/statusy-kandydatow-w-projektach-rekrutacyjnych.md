...
Kandydat może trafić do projektu na dwa sposoby:
...
1. **Dodani ręcznie** — kolumna kandydatów dodanych ręcznie (przycisk + do wyszukiwania i dodawania).
2. **Screening** — trzy kolumny: *Odrzuceni po CV* | *Aplikowali* | *Przeszli screening*.
3. **Proces ofertowy** — cztery kolumny: *Oczekują na rozmowę* → *Do wysłania do klienta* → *Wysłani do klienta* → *Zaakceptowani*.
