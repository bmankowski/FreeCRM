...
class User
{
	...
	public static function &getUserModel($userId)
	{
		...
		$privileges = ($privileges && is_array($privileges) && isset($privileges['_privileges'])) ? $privileges['_privileges'] : null;
	...
	{
		return isset($this->privileges['details'][$fieldName]) ? $this->privileges['details'][$fieldName] : null;
	}
	 ...
	 * @return \App\Modules\Settings\Roles\Models\Record
	 */
	public function getRoleInstance()
	{
		...
		return $this->privileges['roleInstance'] = \App\Modules\Settings\Roles\Models\Record::getInstanceById($this->getRole());
	}
