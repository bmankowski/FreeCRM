...
class CRM_Viewer extends \Smarty
{
	...
	$this->registerClass('App\Privilege', '\App\Security\Privilege'); // Register Privilege class with short name
		...
		$this->registerClass('\App\\Modules\\Settings\\Template\\Models\\Module', '\App\\Modules\\Settings\\Template\\Models\\Module');
		...
		$this->registerClass('Settings_Template_Module_Model', '\App\\Modules\\Settings\\Template\\Models\\Module');
