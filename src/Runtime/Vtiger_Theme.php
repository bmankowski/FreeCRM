...
class Vtiger_Theme extends \App\Runtime\CRM_Viewer
{
	...
	public static function getImagePath(string $imageFileName)
	{
		...
		$completeImageFilePath = \App\Core\Loader::resolveNameToPath('~' . $imageFilePath);
		$completeFallBackThemePath = \App\Core\Loader::resolveNameToPath('~' . $fallbackPath);
	...
	{
		$theme = \App\Modules\Users\Models\Record::getCurrentUserModel()->get('theme');
	...
	{
		return \App\Modules\Base\Helpers\Util::getAllSkins();
	}
