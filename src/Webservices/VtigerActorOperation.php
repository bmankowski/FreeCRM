...
require_once ROOT_DIRECTORY . '/src/Webservices/VtigerCRMActorMeta.php';
...
class VtigerActorOperation extends WebserviceEntityOperation
{
	...
	protected function getMetaInstance()
	{
		if (empty(WebserviceEntityOperation::$metaCache[$this->webserviceObject->getEntityName()][$this->user->id])) {
			WebserviceEntityOperation::$metaCache[$this->webserviceObject->getEntityName()][$this->user->id] = new VtigerCRMActorMeta($this->entityTableName, $this->webserviceObject, $this->pearDB, $this->user);
		}
