...
class Module extends \App\Modules\Settings\Base\Models\Module
{
	...
	{
		return 'index.php?module=Template&parent=Settings&view=ListView';
	}
	...
	{
		return "javascript:Settings_Template_ListView_Js.triggerCreate('" . self::getCreateRecordUrl() . "')";
	}

	public static function getCreateRecordUrl()
	{
		return 'index.php?module=Template&parent=Settings&view=Edit&mode=Step1';
	}

	public static function getImportViewUrl()
	{
		return 'index.php?module=Template&parent=Settings&view=Import';
	}
