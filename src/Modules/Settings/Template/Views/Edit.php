...
class Edit extends \App\Modules\Settings\Base\Views\Index
{
	...
	public function step($step, \App\Http\Vtiger_Request $request)
	{
		...
		if ($recordId) {
			...
			$pdfModel = \App\Modules\Settings\Template\Models\Record::getCleanInstance();
		}
		...
		switch ($step) {
			...
			case 'step3':
				...
				$dynamicElements = \App\Modules\Settings\TemplateDynamicElements\Models\Record::getActiveElements($selectedModuleName, $pdfModel->get('language') ?: null);
			...
			case 'step2':
				...
				asort($languages);
				$viewer->assign('PAGE_FORMATS', \App\Modules\Settings\Template\Models\Module::getPageFormats());
				$viewer->assign('LANGUAGES', $languages);
				$docLayouts = \App\Modules\Settings\TemplateDynamicElements\Models\Record::getActiveDocumentLayouts(
					$selectedModuleName,
			...
			case 'step1':
			default:
				$allModules = \App\Modules\Settings\Template\Models\Module::getSupportedModules();
	...
	public function getFooterScripts(\App\Http\Vtiger_Request $request)
	{
		...
		$jsFileNames = [
			...
			"modules.Settings.$moduleName.resources.Edit3TemplateGeneratorFooter",
