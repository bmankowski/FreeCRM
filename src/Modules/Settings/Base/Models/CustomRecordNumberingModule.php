...
class CustomRecordNumberingModule extends \App\Modules\Base\Models\Module
{
	...
	public static function getSupportedModules()
	{
		...
		for ($i = 0; $i < $numOfRows; $i++) {
			...
			$modulesModels[$tabId] = \App\Modules\Settings\Base\Models\CustomRecordNumberingModule::getInstance($db->query_result($result, $i, 'name'), $tabId);
		}
