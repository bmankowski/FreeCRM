...
class CustomRecordNumberingAjax extends \App\Modules\Settings\Base\Actions\Index
{
	...
	public function checkPermission(\App\Http\Vtiger_Request $request)
	{
		...
		if (!$sourceModule) {
			throw new \App\Exceptions\AppException(\App\Runtime\Vtiger_Language_Handler::translate('LBL_PERMISSION_DENIED', $qualifiedModuleName));
		}
	}
	...
	{
		$qualifiedModuleName = $request->getModule(false);
		$moduleModel = \App\Modules\Settings\Base\Models\CustomRecordNumberingModule::getInstance($request->get('sourceModule'));
	...
	public function updateRecordsWithSequenceNumber(\App\Http\Vtiger_Request $request)
	{
		...
		$moduleModel = \App\Modules\Settings\Base\Models\CustomRecordNumberingModule::getInstance($sourceModule);
