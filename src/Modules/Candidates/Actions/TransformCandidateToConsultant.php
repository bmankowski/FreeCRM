...
//            $newConsultant->set('dodatek_phone', $actualRemunerationTerms->get('stawka_za_phone'));
//            $newConsultant->set('work_time_type', $actualRemunerationTerms->get('work_time_type'));
