...
class Candidates extends \App\Core\CRMEntity
{
	public $table_name = 'u_yf_candidates';
	public $table_index = 'candidatesid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	public $customFieldTable = ['u_yf_candidatescf', 'candidatesid'];

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	public $tab_name = ['vtiger_crmentity', 'u_yf_candidates', 'u_yf_candidatescf'];
	...
	public $tab_name_index = [
		...
		'u_yf_candidates' => 'candidatesid',
		'u_yf_candidatescf' => 'candidatesid',
	];
	...
	public $search_fields = [
		...
		'Nazwisko i imię' => ['candidates', 'name'],
