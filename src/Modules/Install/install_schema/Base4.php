	...
	public function data()
	{
		$this->data = [
			...
			'vtiger_users' => [
				...
				'values' => [
						[1, 'admin', '$1$ad000000$hzXFXvL3XVlnUE/X.1n9t/', 'd41d8cd98f00b204e9800998ecf8427e', '#E6FAD8', '', 'Administrator', 0, 'on', 1, '', 'NOW()', 'NOW()', NULL, 'help@titantech.pl', 'Active', NULL, NULL, NULL, NULL, NULL, NULL, 'yyyy-mm-dd', '24', '08:00', '23:00', 'This Month', 'Today', '', 0, '$1$ad000000$nYTnfhTZRmUP.wQT9y1AE.', 1, '15 Minutes', NULL, 'PHP5.3MD5', 'aOFXop10GCJ1uw0P', 'twilight', 'en_us', 'Europe/Sarajevo', '123456789', ',', ' ', '1.0$', '', 2, 1, 'Monday', 60, 60, 'private', 'Summary', 0, 'medium', 'PLL_PLANNED', 'Meeting', '1', 1, 1, 0, NULL],
				]
			],
			'vtiger_users2group' => [
