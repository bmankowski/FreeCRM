...
CREATE TABLE `vtiger_field` (
  ...
  `field_kind` varchar(50) NOT NULL DEFAULT '',
  `fieldname` varchar(50) NOT NULL,
  ...
  `storage_type` varchar(20) NOT NULL DEFAULT '',
  ...
  PRIMARY KEY (`fieldid`),
  KEY `field_mandatory_idx` (`mandatory`),
  KEY `field_kind_idx` (`field_kind`),
  KEY `field_storage_type_idx` (`storage_type`),
...
CREATE TABLE `vtiger_servicecontracts` (
  ...
  `used_units` decimal(10,2) DEFAULT NULL,
  `subject` varchar(100) DEFAULT NULL,
  `due_date` date DEFAULT NULL,
...
CREATE TABLE `vtiger_users` (
  ...
  `photo_storage_path` varchar(500) DEFAULT NULL,
  `photo_mime_type` varchar(127) DEFAULT NULL,
  `photo_size_bytes` int(10) unsigned NOT NULL DEFAULT '0',
  `deleted` tinyint(1) unsigned NOT NULL DEFAULT '0',
