				...
				<div class="row">
					<div>
						<div class="col-md-10 inner-container">
							<p>{"LBL_DESCRIPTION_CONDITIONS"|t:"Install"}</p>
						</div>
						<div class="pull-right col-md-2">
							<input type="checkbox" id="checkBox3" name="checkBox3"  required /><div class="chkbox"></div> {"LBL_ACCEPT"|t:"Install"}</a>
						</div>
				...
				<div class="row">
					<div>
						<div class="button-container">
							<input id="agree" type="submit" class="btn btn-sm btn-primary" value="{"LBL_NEXT"|t:"Install"}"/>
						</div>
					</div>
				</div>
			</form>
