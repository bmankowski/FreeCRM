...
final class UpdateAllCronTasksToHandlerClass
{
	...
	private const ID_TO_CLASS = [
		...
		10 => \App\Modules\OSSMailScanner\Cron\MailScannerActionTask::class,
		11 => \App\Modules\OSSMailScanner\Cron\MailScannerVerificationTask::class,
		12 => \App\Modules\OSSMailScanner\Cron\MailScannerBindTask::class,
