...
class RemoveWidget  extends \App\Modules\Base\Views\Index
{
	...
	public function process(\App\Http\Vtiger_Request $request)
	{
		...
		if ($request->has('widgetid')) {
			$widget = \App\Modules\Base\Models\Widget::getInstanceWithWidgetId($request->get('widgetid'), $currentUser->getId());
		} else {
