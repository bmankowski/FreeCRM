...
class ChartFilter extends \App\Runtime\BaseModel
{
	...
	public function getTargetModuleModel()
	{
		if (!$this->targetModuleModel) {
			$this->targetModuleModel = \App\Modules\Base\Models\Module::getInstance($this->getTargetModule());
		}
	...
	public function getTitle($prefix = '')
	{
		...
		if (empty($title)) {
			...
			if ($db->num_rows($customviewrs)) {
				...
				$groupFieldModel = \App\Modules\Base\Models\Field::getInstance($this->extraData['groupField'], $this->getTargetModuleModel());
