 ...
 */
class Watchdog extends \App\Runtime\BaseModel
{
	 ...
	 * @param int $userId
	 * @return \App\Modules\Base\Models\Watchdog
	 */
	...
	{
		if ($ownerId === false) {
			$ownerId = (int) (\App\User\CurrentUser::getId() ?? 0);
		}
	...
	{
		return \App\Modules\Base\Models\Module::getAll([0], ['SMSNotifier', 'Integration', 'Dashboard', 'ModComments', 'Notification'], true);
	}
}
