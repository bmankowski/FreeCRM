...
class FindDuplicate extends \App\Runtime\BaseModel
{
	...
	public function getListViewHeaders()
	{
		...
		$listViewHeaders = [];
		$listViewHeaders[] = new \App\Modules\Base\Models\Base(array('name' => 'recordid', 'label' => 'ID'));
	...
	public function getListViewEntries(\App\Modules\Base\Models\Paging $paging)
	{
		$db = \App\Database\PearDatabase::getInstance();
		$moduleModel = $this->getModule();
