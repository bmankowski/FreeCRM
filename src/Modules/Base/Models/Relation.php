...
class Relation extends \App\Runtime\BaseModel
{
	...
	public function getParentModuleModel()
	{
		if (empty($this->parentModule)) {
			$this->parentModule = \App\Modules\Base\Models\Module::getInstance($this->get('tabid'));
		}
	 ...
	 * @param \App\Modules\Base\Models\Module $relationModel
	 * @return $this
	 */
	...
	public function getRelationModuleModel()
	{
		if (!$this->relatedModule) {
			$this->relatedModule = \App\Modules\Base\Models\Module::getInstance($this->get('related_tabid'));
		}
	 ...
	 * @param \App\Modules\Base\Models\Module $parentModuleModel
	 * @param \App\Modules\Base\Models\Module $relatedModuleModel
	...
	/**
	 * Get query fields
	 * @return \App\Modules\Base\Models\Field[] with field name as key
	 */
	...
	public function getManyToMany()
	{
		$queryGenerator = $this->getQueryGenerator();
		$relatedModuleName = $this->getRelationModuleName();
		$referenceInfo = \App\Modules\Base\Models\Relation::getReferenceTableInfo($relatedModuleName, $this->getParentModuleModel()->getName());
