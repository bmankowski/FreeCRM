...
class Module extends \vtlib\Module
{
	...
	public function isCommentEnabled()
	{
		...
		$commentsModuleModel = \App\Modules\Base\Models\Module::getInstance('ModComments');
	...
	public function getBlocks()
	{
		if (empty($this->blocks)) {
			$blocksList = [];
			$moduleBlocks = \App\Modules\Base\Models\Block::getAllForModule($this);
	...
	public function getFields($blockInstance = false)
	{
		if (empty($this->fields)) {
			$moduleBlockFields = \App\Modules\Base\Models\Field::getAllForModule($this);
			$this->fields = [];
	...
	{
		return \App\Modules\Base\Models\Field::getInstance($fieldName, $this);
	}
	 ...
	 * @return \App\Modules\Base\Models\Field[] with field id as key
	 */
	...
	public function getRelations()
	{
		if (empty($this->relations)) {
			$this->relations = \App\Modules\Base\Models\Relation::getAllRelations($this);
		}
	 ...
	 * @return array - List of \App\Modules\Base\Models\Module instances
	 */
	...
	public function getSideBarLinks($linkParams)
	{
		...
		$treeViewModel = \App\Modules\Base\Models\TreeView::getInstance($this);
	...
	public function getValuesFromSource(\App\Http\Vtiger_Request $request, $moduleName = false)
	{
		...
		if ($sourceModule && ($sourceRecord || $sourceRecordData)) {
			...
			if (empty($sourceRecord)) {
				$recordModel = \App\Modules\Base\Models\Record::getCleanInstance($sourceModule);
				$recordModel->setData($sourceRecordData);
			} else {
				$recordModel = \App\Modules\Base\Models\Record::getInstanceById($sourceRecord, $sourceModule);
			}
