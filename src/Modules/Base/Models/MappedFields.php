...
class MappedFields extends \App\Runtime\BaseModel
{
	...
	{
		return \App\Modules\Base\Models\Module::getInstance($this->getName());
	}

	public function getRelatedModule()
	{
		return \App\Modules\Base\Models\Module::getInstance($this->getRelatedName());
	}
