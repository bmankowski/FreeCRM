...
class TreeCategoryModal  extends \App\Modules\Base\Views\Index
{
	...
	public function process(\App\Http\Vtiger_Request $request)
	{
		...
		$treeCategoryModel = \App\Modules\Base\Models\TreeCategoryModal::getInstance($moduleModel);
	...
	public function getModalScripts(\App\Http\Vtiger_Request $request)
	{
		...
		if (\App\Core\AppConfig::relation('SELECTABLE_CATEGORY')) {
		...
		$scripts[] = 'modules.Base.resources.TreeCategoryModal';
