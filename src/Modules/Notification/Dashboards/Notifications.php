...
class Notifications extends \Vtiger_Index_View
{
	...
	public function process(Vtiger_Request $request)
	{
		...
		$notificationModel = \App\Modules\Notification\Models\Module::getInstance($moduleName);
		$notifications = $notificationModel->getEntries($limit, $condition);

		$typesNotification = $notificationModel->getTypes();
		array_unshift($typesNotification, \App\Runtime\Vtiger_Language_Handler::translate('All'));
