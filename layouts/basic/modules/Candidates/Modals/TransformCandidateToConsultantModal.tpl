...
{strip}
	<!-- tpl-Candidates-Modals-TransformCandidateToConsultant -->
			...
			{App\Language::translate('LBL_TRANSFORM_CANDIDATE_TO_CONSULTANT_DESC',$MODULE_NAME)}
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr><td><label class="font-weight-bold mb-0">Czy ITC daje phone?</label></td><td><select name="" value=><option value="tak">tak</option><option value="nie">nie</option></select></td></tr>
