...
<!-- layouts/basic/modules/Campaigns/RelatedList.tpl -->
    {if !empty($CUSTOM_VIEWS)}
        <div class="relatedContainer listViewPageDiv margin0px">
            ...
            <input type="hidden" id="selectedIds" name="selectedIds" data-selected-ids={\App\Utils\Json::encode($SELECTED_IDS)} />
            <input type="hidden" id="excludedIds" name="excludedIds" data-excluded-ids={\App\Utils\Json::encode($EXCLUDED_IDS)} />
