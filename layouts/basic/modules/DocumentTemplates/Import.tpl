...
{strip}
<!-- layouts/basic/modules/DocumentTemplates/Import.tpl -->
	<div class="row">
		<div class="col-md-12">
		...
		{if isset($UPLOAD)}
			{if $UPLOAD eq true}
				<p class="bgMessage bgOK">
					{"LBL_UPLOAD_OK"|t:$QUALIFIED_MODULE} <a class="tdUnderline" href="index.php?module=DocumentTemplates&view=Edit&record={$RECORDID}"> {"LBL_GO_TO_TEMPLATE"|t:$QUALIFIED_MODULE}</a>
				</p>
