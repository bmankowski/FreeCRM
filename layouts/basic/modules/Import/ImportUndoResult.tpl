...
-->*}
{strip}
<!-- layouts/basic/modules/Import/ImportUndoResult.tpl -->
		...
		<div class="panel panel-default">
			...
			<div class="panel-body form-horizontal font-larger">
				...
				<div class="form-group">
					<div class="col-md-7 col-sm-6 col-xs-8 textAlignRight fontBold">{'LBL_TOTAL_RECORDS'|t:$MODULE}:</div>
					<div class="col-md-5 col-sm-6 col-xs-4">
						{$TOTAL_RECORDS}
					</div>
				</div>
				<div class="form-group">
					<div class="col-md-7 col-sm-6 col-xs-8 textAlignRight fontBold">{'LBL_NUMBER_OF_RECORDS_DELETED'|t:$MODULE}:</div>
					<div class="col-md-5 col-sm-6 col-xs-4">
