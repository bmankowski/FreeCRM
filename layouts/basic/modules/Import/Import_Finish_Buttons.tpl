...
<button name="next" class="delete btn btn-danger marginBottom10px"
		onclick="location.href='index.php?module={$FOR_MODULE}&view=Import&mode=undoImport&foruser={$OWNER_ID}&type={$TYPE}'"><strong>{'LBL_UNDO_LAST_IMPORT'|t:$MODULE}</strong></button>
&nbsp;&nbsp;
{/if}
