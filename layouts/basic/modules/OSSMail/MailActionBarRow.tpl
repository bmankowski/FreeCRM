...
<!-- layouts/basic/modules/OSSMail/MailActionBarRow.tpl -->
	<div class="rowRelatedRecord" data-id="{$RELATED['id']}" data-module="{$RELATED['module']}">
		...
		<div class="pull-right rowActions">
			...
			{/if}
			{if \App\Modules\Users\Models\Privileges::isPermitted('ModComments','CreateView')}
				<button class="addRelatedRecord" data-module="ModComments" title="{"LBL_ADD_MODCOMMENTS"|t:$MODULE_NAME}">
					<span class="glyphicon glyphicon-comment" aria-hidden="true"></span>
				</button>
			{/if}
			{if in_array($RELATED['module'], ['HelpDesk','Project']) &&  \App\Modules\Users\Models\Privileges::isPermitted('HelpDesk','CreateView')}
			...
			{/if}
			{if in_array($RELATED['module'], ['Accounts','Contacts','Leads']) && \App\Modules\Users\Models\Privileges::isPermitted('Products','DetailView')}
			...
			{/if}
			{if in_array($RELATED['module'], ['Accounts','Contacts','Leads']) &&  \App\Modules\Users\Models\Privileges::isPermitted('Services','DetailView')}
