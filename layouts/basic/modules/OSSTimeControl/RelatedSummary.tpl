...
<!-- layouts/basic/modules/OSSTimeControl/RelatedSummary.tpl -->
	<div class="sumaryRelatedTimeControl">
		...
		{assign var=TOTALTIME value=$RELATED_SUMMARY['totalTimeFormatted']}
		{if count($RELATED_SUMMARY['userTime']) gt 0 }
			...
			<div class="row chartContainer">
				<div class="col-md-12">
					<input class="widgetData" type="hidden" value='{\App\Modules\Base\Helpers\Util::toSafeHTML(\App\Utils\Json::encode($RELATED_SUMMARY['userTime']))}' />
