...
<!-- layouts/basic/modules/Base/HeaderReminderButton.tpl -->
	{if $REMINDER_ACTIVE}
		<a class="btn btn-default btn-sm isBadge remindersNotice popoverTooltip {if AppConfig::module('Calendar', 'AUTO_REFRESH_REMINDERS')}autoRefreshing{/if}" data-content="{'LBL_REMINDER'|t}">
