{strip}
	<!-- layouts/basic/modules/Base/DetailViewBlockView.tpl -->
	{*<!--
/*********************************************************************************
				...
				<div class="panel panel-default row no-margin" data-label="{$BLOCK_LABEL_KEY}">
					<div class="row blockHeader panel-heading no-margin">
						<div class="iconCollapse">
							<span class="cursorPointer blockToggle glyphicon glyphicon-menu-right {if !($IS_HIDDEN)}hide{/if}"
								alt="{'LBL_EXPAND_BLOCK'|t}" data-mode="hide"
								data-id={$BLOCK_LIST[$BLOCK_LABEL_KEY]->get('id')}></span>
							<span class="cursorPointer blockToggle glyphicon glyphicon glyphicon-menu-down {if $IS_HIDDEN}hide{/if}"
								alt="{'LBL_COLLAPSE_BLOCK'|t}" data-mode="show"
								data-id={$BLOCK_LIST[$BLOCK_LABEL_KEY]->get('id')}></span>
