...
-->*}
{strip}
<!-- layouts/basic/modules/Base/RelatedActivities.tpl -->
	...
	{if count($ACTIVITIES) neq '0'}
		...
		{foreach item=RECORD key=KEY from=$ACTIVITIES name=activities}
			...
			<div class="activityEntries padding5"
				...
				<div class="row">
					<span class="col-md-6">
						<strong title='{\App\Modules\Base\Helpers\Util::formatDateTimeIntoDayString("$START_DATE $START_TIME")}'><span class="glyphicon glyphicon-time"></span>&nbsp;&nbsp;{\App\Modules\Base\Helpers\Util::formatDateIntoStrings($START_DATE, $START_TIME)}</strong>
					</span>
					<span class="col-md-6 rightText">
						<strong title='{\App\Modules\Base\Helpers\Util::formatDateTimeIntoDayString("$END_DATE $END_TIME")}'><span class="glyphicon glyphicon-time"></span>&nbsp;&nbsp;{\App\Modules\Base\Helpers\Util::formatDateIntoStrings($END_DATE, $END_TIME)}</strong>
					</span>
				</div>
