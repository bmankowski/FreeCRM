...
{strip}
<!-- layouts/basic/modules/Base/TreePopup.tpl -->
<div id="treePopupContainer" class="contentsDiv paddingLeftRight10px">
	...
	<input type="hidden" name="tree" id="treePopupValues" value="{\App\Modules\Base\Helpers\Util::toSafeHTML($TREE)}" />
	<input type="hidden" name="isMultiple" id="isMultiple" value="{$IS_MULTIPLE}" />
	{assign var="MODULE_INSTANCE" value=\App\Modules\Base\Models\Module::getInstance($MODULE)}
