...
<!-- layouts/basic/modules/Base/inventoryfields/EditViewTax.tpl -->
	...
	<div class="input-group input-group-sm">
		...
		{if $TAXS_CONFIG['taxs'][0] != ''}
			<input name="taxparam{$ROW_NO}" type="hidden" value="{\App\Modules\Base\Helpers\Util::toSafeHTML($ITEM_DATA['taxparam'])}" class="taxParam" {if $FIELD->get('displaytype') == 10}readonly="readonly"{/if} />
