...
<!-- layouts/basic/modules/Base/inventoryfields/EditViewComment.tpl -->
	...
	<textarea name="{$FIELD->getColumnName()}{$ROW_NO}" title="{"LBL_ROW_COMMENT"|t:$MODULE}" id="editView_comment{$FIELD->getColumnName()}{$ROW_NO}" data-fieldinfo="{\App\Utils\Json::encode(['mandatory' => false])|escape}"
