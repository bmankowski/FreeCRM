...
{strip}
<!-- layouts/basic/modules/Base/inventoryfields/EditViewUnitPrice.tpl -->
	...
	<div class="input-group input-group-sm">
		...
		{assign var=PRICEBOOK_MODULE_MODEL value=\App\Modules\Base\Models\Module::getInstance('PriceBooks')}
		{if $PRICEBOOK_MODULE_MODEL->isPermitted('DetailView')}
			<span class="input-group-addon priceBookPopup cursorPointer">
				<span class="userIcon-PriceBooks"  data-popup="Popup" data-module-name="PriceBooks" alt="{"PriceBooks"|t:$MODULE}" title="{"PriceBooks"|t:$MODULE}"/></span>
			</span>
		{/if}
	</div>
<!--/layouts/basic/modules/Base/inventoryfields/EditViewUnitPrice.tpl -->
