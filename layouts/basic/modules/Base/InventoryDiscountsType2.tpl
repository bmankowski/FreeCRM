...
{strip}
<!-- layouts/basic/modules/Base/InventoryDiscountsType2.tpl -->
	{if $DISCOUNT_TYPE == '0'}
		<div class="panel panel-default">
			<div class="panel-heading">
				<strong>{"LBL_INDIVIDUAL_DISCOUNTS"|t:$MODULE}</strong>
						...
						<div class="col-md-6">
							<div class="radio">
								<label>
									...
									{"LBL_PERCENTAGE_DISCOUNTS"|t:$MODULE}
								</label>
							</div>
						</div>
						<div class="col-md-6">
