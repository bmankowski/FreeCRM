{strip}
<!-- layouts/basic/modules/Base/data_access/colorList.tpl -->{assign var=BG value=$SAVED_DATA['bg']}
{assign var=TEXT value=$SAVED_DATA['text']}
<div class="row">
	<div class="col-md-6">
		<h5 class="padding-bottom1per"><strong>{"LBL_BACKGROUND_COLOR"|t:"DataAccess"}:</strong></h5>
		<p class="calendarColorPickerBG"></p>
		<input name="bg" type="hidden" id="calendarColorPickerBG" value="{$BG}">
	</div>
	<div class="col-md-6">
		<h5 class="padding-bottom1per"><strong>{"LBL_TEXT_COLOR"|t:"DataAccess"}:</strong></h5>
...
<!--/layouts/basic/modules/Base/data_access/colorList.tpl -->
{/strip}
