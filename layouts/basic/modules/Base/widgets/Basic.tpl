...
<div class="summaryWidgetContainer">
	<div class="widgetContainer_{$key} widgetContentBlock" data-url="{\App\Modules\Base\Helpers\Util::toSafeHTML($WIDGET['url'])}" data-name="{$WIDGET['label']}" data-type="{$WIDGET['type']}">
