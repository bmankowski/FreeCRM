...
-->*}
{strip}
<!-- layouts/basic/modules/Base/dashboards/AssignedProjectsTasksContents.tpl -->
<style type="text/css">
small.small-a{
font-size: 75%;
}
...
<div>
	...
	<div>
		...
		<div>
			...
			<p class='pull-right muted' style='margin-top:5px;padding-right:5px;'><small title="{\App\Modules\Base\Helpers\Util::formatDateTimeIntoDayString($TARGETENDDATE)}">{$TARGETENDDATE}</small></p>
