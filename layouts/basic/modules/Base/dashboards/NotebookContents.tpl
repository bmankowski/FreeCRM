 ...
 *************************************************************************************}
{strip}
<!-- layouts/basic/modules/Base/dashboards/NotebookContents.tpl -->
<div style='padding:5px'>
	<div class="">
		<div class="dashboard_notebookWidget_view row">
			<div class="">
				<span class="col-md-10 muted">
					<i>{"LBL_LAST_SAVED_ON"|t:$MODULE}</i> {\App\Modules\Base\Helpers\Util::formatDateTimeIntoDayString($WIDGET->getLastSavedDate())}
				</span>
				<span class="col-md-2">
					<span class="pull-right">
						<button class="btn btn-xs btn-default pull-right dashboard_notebookWidget_edit">
							<strong>{"LBL_EDIT"|t:$MODULE}</strong>
						</button>
					</span>
				</span>
			</div>
