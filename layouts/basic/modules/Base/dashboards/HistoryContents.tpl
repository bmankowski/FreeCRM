		...
		{if $MODELNAME == '\App\Modules\ModTracker\Models\Record'}
						...
						<div class='' style='margin-top:5px'>
							<strong>{$USER->getName()}&nbsp;</strong>
								...
								{if $RELATION->getLinkedRecord()->getModuleName() eq 'Calendar'}
									{if \App\Security\Privilege::isPermitted('Calendar', 'DetailView', $RELATION->getLinkedRecord()->getId())}
			...
			<div class="row">
				...
				<div class="col-md-11">
					...
					<div class='font-x-small'><span>"{$HISTORY->get('commentcontent')|default:''|nl2br}"</span></div>
				</div>
			</div>
		{/if}
	{/foreach}
