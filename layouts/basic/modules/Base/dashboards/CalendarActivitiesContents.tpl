...
-->*}
{strip}
<!-- layouts/basic/modules/Base/dashboards/CalendarActivitiesContents.tpl -->
<style type="text/css">
small.small-a{
font-size: 75%;
}
		...
		<div class="changeActivity cursorPointer" data-url="{$ACTIVITY->getActivityStateModalUrl()}" accesskey=""
			...
			<div>
				<div class="pull-left marginLeft5 marginTop5">
					...
					<image src="{vimage_path_default($ACTIVITY_TYPE, Calendar)}" alt="{"LBL_$ACTIVITY_UPPERCASE"|t}" width="24px" />&nbsp;&nbsp;
				</div>
				...
				<p class="pull-right muted paddingLR10 marginTop5">
					<small title="{\App\Modules\Base\Helpers\Util::formatDateTimeIntoDayString("$START_DATE $START_TIME")} {"LBL_ACTIVITY_TO"|t} {\App\Modules\Base\Helpers\Util::formatDateTimeIntoDayString("$DUE_DATE $DUE_TIME")}">
						{\App\Modules\Base\Helpers\Util::formatDateDiffInStrings("$DUE_DATE $DUE_TIME")}
					</small>
				</p>
