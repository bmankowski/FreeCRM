...
{strip}
<!-- layouts/basic/modules/HelpDesk/dashboards/ClosedTicketsByPriority.tpl -->
		...
		<div class="row" >
			<div class="col-sm-6">
				<div class="input-group input-group-sm">
					...
					<input type="text" name="time" title="{"Created Time"|t:$MODULE_NAME}" class="dateRange form-control widgetFilter width90" value="{implode(',',$DTIME)}"/>
				</div>
			</div>
			<div class="col-sm-6">
