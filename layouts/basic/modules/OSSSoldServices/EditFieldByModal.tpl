...
{strip}
<!-- layouts/basic/modules/OSSSoldServices/EditFieldByModal.tpl -->
	...
	<input type="hidden" class="hierarchyField" id="hierarchyField" value="{\App\Modules\Base\Helpers\Util::toSafeHTML(\App\Utils\Json::encode($HIERARCHY_FIELD))}">
	{if $RELATED_EXISTS}
		...
		<input type="hidden" class="relatedModule" id="relatedModule" value="{\App\Modules\Base\Helpers\Util::toSafeHTML(\App\Utils\Json::encode($RELATED_MODULE))}">
	{/if}
	<div class="modal-header">
		<div class="col-xs-8">
			<h3 class="modal-title">
				{if $RECORD->get('serviceid')}
					{\App\Records\Record::getLabel($RECORD->get('serviceid'))}
