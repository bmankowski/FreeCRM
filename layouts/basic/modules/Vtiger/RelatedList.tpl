...
-->*}
{strip}
<!-- layouts/basic/modules/Vtiger/RelatedList.tpl -->
					...
					{if $IS_CREATE_PERMITTED}
						<div class="btn-group paddingRight10">
								...
								<button type="button" class="btn addButton btn-default
										{if $IS_SELECT_BUTTON eq true} selectRelation {/if} moduleColor_{$RELATED_MODULE_NAME} {if $RELATED_LINK->get('linkqcs') eq true}quickCreateSupported{/if}"
