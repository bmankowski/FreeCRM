		...
		<div class="widgetContainer_{$key} widgetContentBlock" data-url="{$WIDGET['url']}" data-name="{$WIDGET['label']}">
			<div class="widget_header row">
				<span class="col-md-12 margin0px">
					<div class="row">
						<div class="col-md-4">
							<span class="{$span} margin0px"><h4>{$WIDGET['label']|t:$MODULE_NAME}</h4></span>
						</div>
						<div class="col-md-8" align="center" style="padding-right: 40px;">
							<div class="btn-group" data-toggle="buttons">
								{foreach name=BTN item=COUNT key=MODULE_DATA from=\App\Modules\Vtiger\Widgets\ProductsServicesBasic::getModulesAndCount($RECORD)}
