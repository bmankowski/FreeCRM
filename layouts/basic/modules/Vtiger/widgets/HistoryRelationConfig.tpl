...
{strip}
<!-- layouts/basic/modules/Vtiger/widgets/HistoryRelationConfig.tpl -->
				...
				<div class="modal-body">
					<div class="modal-Fields">
						<div class="row">
							...
							<div class="col-md-3 marginLeftZero"><label class="">{"No left margin"|t:$QUALIFIED_MODULE}:</label></div>
							<div class="col-md-7">
							...
							<div class="col-md-3 marginLeftZero"><label class="">{"Limit entries"|t:$QUALIFIED_MODULE}:</label></div>
							<div class="col-md-7">
