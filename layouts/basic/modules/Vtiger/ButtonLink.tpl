...
<!-- layouts/basic/modules/Vtiger/ButtonLink.tpl -->
	...
	{if $LINK->get('linkhref')}<a{else}<button type="button"{/if}{/strip} {strip}
				...
				id="{$MODULE}_{$BUTTON_VIEW}_action_{\App\Modules\Vtiger\Helpers\Util::replaceSpaceWithUnderScores($ACTION_NAME)}"{/strip} {strip}
