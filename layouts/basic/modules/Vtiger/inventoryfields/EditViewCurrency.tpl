...
{strip}
<!-- layouts/basic/modules/Vtiger/inventoryfields/EditViewCurrency.tpl -->
	...
	<input name="currencyparam" type="hidden" value="{\App\Modules\Vtiger\Helpers\Util::toSafeHTML(\App\Json::encode($CURRENCY_PARAMS))}" class="currencyparam" />
