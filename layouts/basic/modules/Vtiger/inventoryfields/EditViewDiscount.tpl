	...
	<div>
		<div class="input-group input-group-sm">
			...
			{if $DISCOUNTS_CONFIG['discounts'][0] != ''}
				<input name="discountparam{$ROW_NO}" type="hidden" value="{\App\Modules\Vtiger\helpers\Util::toSafeHTML($ITEM_DATA['discountparam'])}" class="discountParam" {if $FIELD->get('displaytype') == 10}readonly="readonly"{/if} />
