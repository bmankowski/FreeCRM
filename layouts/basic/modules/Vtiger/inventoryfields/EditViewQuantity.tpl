...
{strip}
<!-- layouts/basic/modules/Vtiger/inventoryfields/EditViewQuantity.tpl -->
	...
	<div class="input-group input-group-sm">
		...
		<span class="input-group-btn">
			<button class="btn btn-default qtyparamButton{if $ITEM_DATA['qtyparam']} active{/if}{if $ITEM_DATA['unit'] !== 'pack'} hidden{/if}" data-rownum="{$ROW_NO}" type="button">{"pcs"|t:"Products"}</button>
		</span>
	</div>
