...
-->*}
{strip}
<!-- layouts/basic/modules/Vtiger/QuickCreate.tpl -->
											...
											<div class="fieldLabel col-xs-12 col-sm-5">
												...
												<label class="muted pull-left-xs pull-right-sm pull-right-lg">
													...
													{if in_array($VIEW,$HELPINFO) && vtranslate($HELPINFO_LABEL, 'HelpInfo') neq $HELPINFO_LABEL}
														<a href="#" class="HelpInfoPopover pull-right" title="" data-placement="auto top" data-content="{htmlspecialchars(vtranslate($MODULE|cat:'|'|cat:$FIELD_MODEL->get('label'), 'HelpInfo'))}" data-original-title='{$FIELD_MODEL->get("label")|t:$MODULE}'><span class="glyphicon glyphicon-info-sign"></span></a>{/if}
