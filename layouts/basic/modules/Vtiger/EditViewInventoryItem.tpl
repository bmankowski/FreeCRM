...
<!-- layouts/basic/modules/Vtiger/EditViewInventoryItem.tpl -->
	...
	<tr class="inventoryRow" numrow="{$ROW_NO}">
		<td>
			<span class="glyphicon glyphicon-trash deleteRow cursorPointer {if $KEY == 0 }hide{/if}" title="{"LBL_DELETE"|t:$MODULE}"></span>
			&nbsp;&nbsp;<a class="dragHandle"><img src="{vimage_path('drag.png')}" border="0" alt="{"LBL_DRAG"|t:$MODULE}"/></a>
