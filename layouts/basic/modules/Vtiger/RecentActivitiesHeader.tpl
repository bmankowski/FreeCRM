...
<!-- layouts/basic/modules/Vtiger/RecentActivitiesHeader.tpl -->
	<div class="row marginBottom10px">
		<div class="col-md-12 btn-toolbar"">
			...
			{if $USER_MODEL->getId() eq $USER_MODEL->getRealId() && $MODULE_MODEL->isPermitted('ReviewingUpdates') && \App\Modules\ModTracker\Models\Record::isNewChange($PARENT_RACORD_ID, $USER_MODEL->getRealId())}
				<div class="pull-right btn-group">
