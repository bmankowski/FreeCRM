		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h3 id="exportCalendarHeader" class="modal-title">{"LBL_EXPORT_RECORDS"|t:$MODULE}</h3>
				</div>
				<form id="exportForm" class="form-horizontal row" method="post" action="index.php">
								...
								<table class="massEditTable table table-bordered">
									<tr>
										<td class="fieldLabel alignMiddle">
											<input type="radio" name="exportCalendar" value = "iCal" checked> {"ICAL_FORMAT"|t:$MODULE}
										</td>
										<td class="fieldValue">
					...
					<div class="modal-footer">
						<button class="btn btn-success" type="submit" name="saveButton" onclick="app.hideModalWindow();" ><strong>{"LBL_EXPORT"|t:$MODULE}</strong></button>
						&nbsp;&nbsp;
						<button class="btn btn-warning" type="reset" data-dismiss="modal">{"LBL_CANCEL"|t:$MODULE}</button>
					</div>
				</form>
			</div>
		</div>
