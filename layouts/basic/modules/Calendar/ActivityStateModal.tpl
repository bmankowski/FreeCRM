...
<div id="activityStateModal" class="modal fade modalEditStatus" tabindex="-1">
	...
	<div class="modal-dialog">
        <div class="modal-content">
			...
			{assign var=ACTIVITYPOSTPONED value=\App\Security\Privilege::isPermitted('Calendar', 'ActivityPostponed', $ID)}
			{assign var=ACTIVITYCANCEL value=\App\Security\Privilege::isPermitted('Calendar', 'ActivityCancel', $ID)}
			{assign var=ACTIVITYCOMPLETE value=\App\Security\Privilege::isPermitted('Calendar', 'ActivityComplete', $ID)}
