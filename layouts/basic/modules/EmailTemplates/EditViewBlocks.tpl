    ...
    <div class='editViewContainer'>
        ...
        <form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="index.php" enctype="multipart/form-data">
			...
			{if $BLOCKS_HIDE}
				<div class="panel panel-default row marginLeftZero marginRightZero blockContainer" data-label="{$BLOCK_LABEL}">					
					<div class="row blockHeader panel-heading marginLeftZero marginRightZero">
						...
						<div class="iconCollapse">
							...
							<h4>{$BLOCK_LABEL|t:$QUALIFIED_MODULE_NAME}</h4>
						</div>
					</div>
				...
				{if $BLOCK_LABEL eq 'LBL_CONTENT_MAIL'}
					{include file='partials/TemplateAttachments.tpl'|@vtemplate_path:'EmailTemplates'}
				{/if}
			{/if}
		{/foreach}
