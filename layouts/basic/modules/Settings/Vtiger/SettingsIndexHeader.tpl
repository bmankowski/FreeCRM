...
<!-- layouts/basic/modules/Settings/Vtiger/SettingsIndexHeader.tpl -->
	...
	<div class="row no-margin">
		<ul class="nav nav-tabs massEditTabs">
			...
			<li class="active" data-mode="index" data-params="{Vtiger_Util_Helper::toSafeHTML(\App\Json::encode(['count'=>$WARNINGS_COUNT]))}"><a data-toggle="tab"><strong>{"LBL_START"|t:$QUALIFIED_MODULE}</strong></a></li>
