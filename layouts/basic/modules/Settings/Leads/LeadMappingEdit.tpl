...
-->*}
{strip}
<!-- layouts/basic/modules/Settings/Leads/LeadMappingEdit.tpl -->
	<div class="">
			...
			<div class="row widget_header settingsHeader marginBottom5">
				...
				<span class="col-xs-12 col-sm-12 col-md-4 ">
					<span class="pull-right">
						<button type="submit" class="btn btn-success"><strong>{"LBL_SAVE"|t:$QUALIFIED_MODULE}</strong></button>
				...
				<table class="table customTableRWD table-bordered" id="convertLeadMapping">
					<thead>
						<tr class="blockHeader">
							<th data-hide='phone,'  class="blockHeader">{"LBL_FIELD_LABEL"|t:$QUALIFIED_MODULE}</th>
							<th data-hide='phone'  class="blockHeader">{"LBL_FIELD_TYPE"|t:$QUALIFIED_MODULE}</th>
			...
			<div class="row pushDown">
				<span class="col-md-4">
					<button id="addMapping" class="btn btn-info addButton" type="button">
						<span class="glyphicon glyphicon-plus"></span>&nbsp;<strong>{"LBL_ADD_MAPPING"|t:$QUALIFIED_MODULE}</strong>
					</button>
				</span>
				<span class="col-md-8">
					<span class="pull-right">
