		...
		<div class="">
			<div class="row padding-bottom1per">
				<span class="col-md-12 row">
					<span class="col-md-2 control-label">{"LBL_SMTP"|t:$QUALIFIED_MODULE}</span>
			...
			<div class="row padding-bottom1per">
				<span class="col-md-7 row">
					<span class="col-md-3 control-label">{"LBL_FROM"|t:$QUALIFIED_MODULE}</span>
					<div class="col-md-9">
				...
				<div class="col-md-5">
					<div class="col-md-12 paddingLRZero">
						<select id="fromEmailOption" class="chzn-select form-control" data-placeholder="{"LBL_SELECT_OPTIONS"|t:$QUALIFIED_MODULE}">
							<option></option>
			...
			<div class="row padding-bottom1per">
				<span class="col-md-7 row">
					<span class="col-md-3 control-label">{"LBL_TO"|t:$QUALIFIED_MODULE}<span class="redColor">*</span></span>
					<div class="col-md-9">
				...
				<div class="col-md-5">
					<div class="col-md-12 paddingLRZero">
						<select class="task-fields chzn-select form-control" data-placeholder="{"LBL_SELECT_OPTIONS"|t:$QUALIFIED_MODULE}">
							<option></option>
			...
			<div class="row padding-bottom1per {if empty($TASK_OBJECT->emailcc)}hide {/if}" id="ccContainer">
				<span class="col-md-7 row">
					<span class="col-md-3 control-label">{"LBL_CC"|t:$QUALIFIED_MODULE}</span>
					<div class="col-md-9">
			...
			<div class="row padding-bottom1per {if empty($TASK_OBJECT->emailbcc)}hide {/if}" id="bccContainer">
				<span class="col-md-7 row">
					<span class="col-md-3 control-label">{"LBL_BCC"|t:$QUALIFIED_MODULE}</span>
					<div class="col-md-9">
			...
			<div class="row padding-bottom1per {if (!empty($TASK_OBJECT->emailcc)) and (!empty($TASK_OBJECT->emailbcc))} hide {/if}">
				<span class="col-md-8 row">
					...
					<span class="col-md-9">
						<a class="btn btn-default {if (!empty($TASK_OBJECT->emailcc))}hide{/if}" id="ccLink">{"LBL_ADD_CC"|t:$QUALIFIED_MODULE}</a>&nbsp;&nbsp;
						<a class="btn btn-default {if (!empty($TASK_OBJECT->emailbcc))}hide{/if}" id="bccLink">{"LBL_ADD_BCC"|t:$QUALIFIED_MODULE}</a>
					</span>
				</span>
			</div>
			<hr/>
			...
			<div class="row padding-bottom1per">
				<span class="col-md-7 row">
					<span class="col-md-3 control-label">{"LBL_SUBJECT"|t:$QUALIFIED_MODULE}<span class="redColor">*</span></span>
					<div class="col-md-9">
