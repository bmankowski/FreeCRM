		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h3 id="massEditHeader" class="modal-title">{"LBL_ADD"|t:$MODULE} {"LBL_ADD_WIDGET_CHARTS"|t:$MODULE}</h3>
				</div>
				<form class="form-horizontal validateForm sendByAjax" >
					...
					<div class="form-group margin0px padding1per">
						<label class="col-sm-3 control-label">{"LBL_NAME_CHART"|t:$MODULE}<span class="redColor">*</span> </label>
						<div class="col-sm-8 controls">
							<input type="text" name="chartName" class="form-control" data-validation-engine="validate[required]" />
						</div>
					</div>
					<div class="form-group margin0px padding1per">
						<label class="col-sm-3 control-label">{"LBL_REPORT"|t:$MODULE}<span class="redColor">*</span></label>
						<div class="col-sm-8 controls">
							<select class="select2 widgetFilter width90 form-control" title="{"LBL_SELECT_USER"|t}" name="reportId" style="margin-bottom:0;" data-validation-engine="validate[required]">
