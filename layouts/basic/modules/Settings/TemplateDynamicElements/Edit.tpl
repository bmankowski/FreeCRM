			...
			<div class="contentsDiv">
				...
				<div class="editViewContainer">
					<form name="EditPDFDynamicElement" id="EditView" class="form-horizontal validateForm" method="post" action="index.php">
						<input type="hidden" name="module" value="TemplateDynamicElements">
						...
						<div class="row">
							<div class="col-md-11">
								<span class="pull-right">
									...
									<a class="cancelLink btn btn-warning" href="index.php?module=TemplateDynamicElements&parent=Settings&view=ListView"><span class="glyphicon glyphicon-remove"></span>&nbsp;{'LBL_CANCEL'|t:$QUALIFIED_MODULE}</a>
								</span>
							</div>
						</div>
					</form>
