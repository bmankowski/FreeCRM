	...
	<ul class="crumbs marginLeftZero">
		<li class="first step {if $STEP eq '1'}active{/if}" style="z-index:9" id="Step1">
			<a>
				...
				<span class="stepText">{"LBL_FILL_BASE_DATA"|t:$QUALIFIED_MODULE}</span>
			</a>
		</li>
		<li style="z-index:8" class="step {if $STEP eq '2'}active{/if}" id="Step2">
			<a>
				<span class="stepNum">2</span>
				<span class="stepText">{"ADD_CONDITIONS"|t:$QUALIFIED_MODULE}</span>
			</a>
		</li>
		<li style="z-index:8" class="step {if $STEP eq '3'}active{/if}" id="Step3">
			<a>
				<span class="stepNum">3</span>
				<span class="stepText">{"ADD_ACTIONS"|t:$QUALIFIED_MODULE}</span>
			</a>
		</li>
	</ul>
</div>
