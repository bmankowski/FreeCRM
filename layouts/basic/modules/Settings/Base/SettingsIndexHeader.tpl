{strip}
<!-- layouts/basic/modules/Settings/Base/SettingsIndexHeader.tpl -->
	...
	<div class="row no-margin">
		<ul class="nav nav-tabs massEditTabs">
			...
			<li class="active" data-mode="index" data-params="{\App\Modules\Base\Helpers\Util::toSafeHTML(\App\Json::encode(['count'=>$WARNINGS_COUNT|default:0]))}"><a data-toggle="tab"><strong>{"LBL_START"|t:$QUALIFIED_MODULE}</strong></a></li>
