		...
		<div class="listViewTopMenuDiv">
			<div class="widget_header row">
				<div class="col-xs-12">
					...
					{"LBL_MAPPEDFIELDS_DESCRIPTION"|t:$QUALIFIED_MODULE}
				</div>
			</div>
			<div class="row">
				<div class="col-md-4 btn-toolbar">
					<button class="btn btn-default addButton" id="addButton" data-url="{$MODULE_MODEL->getCreateRecordUrl()}">
						...
						<strong>{"LBL_ADD_TEMPLATE"|t:$QUALIFIED_MODULE}</strong>
					</button>
					<button class="btn btn-default importButton" id="importButton" data-url="{$MODULE_MODEL->getImportViewUrl()}" title="{"LBL_IMPORT_TEMPLATE"|t:$QUALIFIED_MODULE}">
