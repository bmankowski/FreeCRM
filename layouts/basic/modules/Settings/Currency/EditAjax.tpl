			...
			<div class="modal-content">
				<div class="modal-header contentsBackground">
					...
					{if $CURRENCY_MODEL_EXISTS}
						<h3 class="modal-title">{vtranslate('LBL_EDIT_CURRENCY', $QUALIFIED_MODULE)}</h3>
					{else}
						<h3 class="modal-title">{vtranslate('LBL_ADD_NEW_CURRENCY', $QUALIFIED_MODULE)}</h3>
					{/if}
				</div>
				<form id="editCurrency" class="form-horizontal" method="POST">
					...
					<div class="modal-body">
						<div class="">
							...
							<div class="form-group">
								<label class="muted col-md-4 control-label"><span class="redColor">*</span>&nbsp;{vtranslate('LBL_CURRENCY_CODE', $QUALIFIED_MODULE)}</label>
							...
							<div class="form-group">
								<label class="muted col-md-4 control-label"><span class="redColor">*</span>&nbsp;{vtranslate('LBL_CURRENCY_SYMBOL', $QUALIFIED_MODULE)}</label>
								<div class="col-md-6 controls">
							...
							<div class="form-group">
								<label class="muted col-md-4 control-label"><span class="redColor">*</span>&nbsp;{vtranslate('LBL_CONVERSION_RATE', $QUALIFIED_MODULE)}</label>
								<div class="col-md-6 controls">
									<input type="text" name="conversion_rate" class="form-control" placeholder="{vtranslate('LBL_ENTER_CONVERSION_RATE', $QUALIFIED_MODULE)}" 
