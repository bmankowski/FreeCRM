			...
			<div class="modal-content">
				<div class="modal-header contentsBackground">
					...
					{if $CURRENCY_MODEL_EXISTS}
						<h3 class="modal-title">{"LBL_EDIT_CURRENCY"|t:$QUALIFIED_MODULE}</h3>
					{else}
						<h3 class="modal-title">{"LBL_ADD_NEW_CURRENCY"|t:$QUALIFIED_MODULE}</h3>
					{/if}
				</div>
						...
						<div class="">
							<div class="form-group">
								<label class="muted col-md-4 control-label">
									<span class="redColor">*</span>&nbsp;{"LBL_CURRENCY_NAME"|t:$QUALIFIED_MODULE}
								</label>
							...
							<div class="form-group">
								<label class="muted col-md-4 control-label"><span class="redColor">*</span>&nbsp;{"LBL_CURRENCY_CODE"|t:$QUALIFIED_MODULE}</label>
							...
							<div class="form-group">
								<label class="muted col-md-4 control-label"><span class="redColor">*</span>&nbsp;{"LBL_CURRENCY_SYMBOL"|t:$QUALIFIED_MODULE}</label>
								<div class="col-md-6 controls">
							...
							<div class="form-group">
								<label class="muted col-md-4 control-label"><span class="redColor">*</span>&nbsp;{"LBL_CONVERSION_RATE"|t:$QUALIFIED_MODULE}</label>
								<div class="col-md-6 controls">
									<input type="text" name="conversion_rate" class="form-control" placeholder="{"LBL_ENTER_CONVERSION_RATE"|t:$QUALIFIED_MODULE}" 
									...
									<br><span class="muted">({"LBL_BASE_CURRENCY"|t:$QUALIFIED_MODULE} - {$BASE_CURRENCY_MODEL->get('currency_name')})</span>
								</div>	
							</div>
							<div class="form-group">
								<label class="muted col-md-4 col-xs-2 control-label">{"LBL_STATUS"|t:$QUALIFIED_MODULE}</label>
							...
							<span>&nbsp;{"LBL_CURRENCY_STATUS_DESC"|t:$QUALIFIED_MODULE}</span>
						</label>
					</div>	
				</div>
				<div class="form-group transferCurrency hide">
					<label class="muted col-md-4 control-label"><span class="redColor">*</span>&nbsp;
						{"LBL_TRANSFER_CURRENCY"|t:$QUALIFIED_MODULE}&nbsp;{"LBL_TO"|t:$QUALIFIED_MODULE}</label>
