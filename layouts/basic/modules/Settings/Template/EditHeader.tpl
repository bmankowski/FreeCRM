		...
		<div id="wizardSteps" class="current-{$CURRENT_STEP}">
			<ul class="crumbs marginLeftZero">
				<li class="first step zIndex8 {if $CURRENT_STEP eq 'step1'}active{/if}" id="step1">
					<a href="{if $RECORDID}index.php?module=Template&amp;parent=Settings&amp;view=Edit&amp;record={$RECORDID}&amp;mode=Step1{else}index.php?module=Template&amp;parent=Settings&amp;view=Edit&amp;mode=Step1{/if}">
				...
				<li class="step zIndex7 {if $CURRENT_STEP eq 'step2'}active{/if}" id="step2">
					<a href="{if $RECORDID}index.php?module=Template&amp;parent=Settings&amp;view=Edit&amp;record={$RECORDID}&amp;mode=Step2{else}#{/if}">
				...
				<li class="step zIndex6 {if $CURRENT_STEP eq 'step3'}active{/if}" id="step3">
					<a href="{if $RECORDID}index.php?module=Template&amp;parent=Settings&amp;view=Edit&amp;record={$RECORDID}&amp;mode=Step3{else}#{/if}">
				...
				<li class="step zIndex5 {if $CURRENT_STEP eq 'step4'}active{/if}" id="step4">
					<a href="{if $RECORDID}index.php?module=Template&amp;parent=Settings&amp;view=Edit&amp;record={$RECORDID}&amp;mode=Step4{else}#{/if}">
				...
				<li class="step zIndex4 {if $CURRENT_STEP eq 'step5'}active{/if}" id="step5">
					<a href="{if $RECORDID}index.php?module=Template&amp;parent=Settings&amp;view=Edit&amp;record={$RECORDID}&amp;mode=Step5{else}#{/if}">
				...
				<li class="step last zIndex3 {if $CURRENT_STEP eq 'step6'}active{/if}" id="step6">
					<a href="{if $RECORDID}index.php?module=Template&amp;parent=Settings&amp;view=Edit&amp;record={$RECORDID}&amp;mode=Step6{else}#{/if}">
