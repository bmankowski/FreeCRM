		...
		<div class="input-group input-group-sm">
			...
			<span class="input-group-addon inviteStatus">
				...
				{elseif $INVITIE['status'] == '2'}
					<span class="glyphicon glyphicon-minus-sign popoverTooltip" data-placement="top" data-content="{$STATUS_LABEL|t:$MODULE} {if $INVITIE['time']}({DateTimeField::convertToUserFormat($INVITIE['time'])}){/if}" aria-hidden="true"></span>
				{else}
					{assign var=LABEL value=$INVITIE['email']}
