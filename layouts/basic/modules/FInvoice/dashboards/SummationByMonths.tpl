...
{assign var=CONF_DATA value=\App\Utils\Json::decode(html_entity_decode($WIDGET->get('data')))}
...
<div class="dashboardWidgetHeader">
	<div class="row">
		<div class="col-md-8">
			<div class="dashboardTitle" title="{$WIDGET->getTitle()|t:$MODULE_NAME}">
				<strong>&nbsp;&nbsp;{$WIDGET->getTitle()|t:$MODULE_NAME}</strong>
			</div>
		</div>
		<div class="col-md-4">
