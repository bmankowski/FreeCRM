...
-->*}
{strip}
<!-- layouts/basic/modules/Reports/ChartEditStep2.tpl -->
	<form class="form-horizontal recordEditView" id="chart_report_step2" method="post" action="index.php">
		...
		<div class="">
			<div class="">
				<h4><strong>{"LBL_CHOOSE_FILTER_CONDITIONS"|t:$MODULE}</strong></h4><br>
		...
		<div class="pull-right block">
			...
			<button class="cancelLink btn btn-warning" onclick="window.history.back()">{"LBL_CANCEL"|t:$MODULE}</button>&nbsp;&nbsp;
		</div>
		<br><br>
	</form>
<!--/layouts/basic/modules/Reports/ChartEditStep2.tpl -->
