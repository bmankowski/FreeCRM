...
<!-- layouts/basic/modules/Reports/step3.tpl -->
	<form class="form-horizontal recordEditView" id="report_step3" method="post" action="index.php">
		...
		<input type="hidden" name="selected_fields" id="seleted_fields" value='{\App\Modules\Base\Helpers\Util::toSafeHTML(\App\Utils\Json::encode($REPORT_MODEL->get('selected_fields')))}' />
		<input type="hidden" name="selected_sort_fields" id="selected_sort_fields" value={\App\Modules\Base\Helpers\Util::toSafeHTML(\App\Utils\Json::encode($REPORT_MODEL->get('selected_sort_fields')))} />
		<input type="hidden" name="selected_calculation_fields" id="calculation_fields" value={\App\Modules\Base\Helpers\Util::toSafeHTML(\App\Utils\Json::encode($REPORT_MODEL->get('calculation_fields')))} />
