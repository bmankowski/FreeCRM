...
<!-- layouts/basic/modules/Reports/step2.tpl -->
	<form class="form-horizontal recordEditView" id="report_step2" method="post" action="index.php">
		...
		<input type="hidden" name="selected_fields" id="seleted_fields" value='{\App\Modules\Base\Helpers\Util::toSafeHTML(\App\Json::encode($SELECTED_FIELDS))}' />
		...
		<input type="hidden" name="schdayoftheweek" value="{\App\Modules\Base\Helpers\Util::toSafeHTML(\App\Json::encode($REPORT_MODEL->get('schdayoftheweek')))}">
		<input type="hidden" name="schdayofthemonth" value="{\App\Modules\Base\Helpers\Util::toSafeHTML(\App\Json::encode($REPORT_MODEL->get('schdayofthemonth')))}">
		<input type="hidden" name="schannualdates" value="{\App\Modules\Base\Helpers\Util::toSafeHTML(\App\Json::encode($REPORT_MODEL->get('schannualdates')))}">
		<input type="hidden" name="recipients" value="{\App\Modules\Base\Helpers\Util::toSafeHTML(\App\Json::encode($REPORT_MODEL->get('recipients')))}">
